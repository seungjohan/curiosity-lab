# Design Spec: Planting & Horticulture Category

## 1. Purpose
Introduce a new knowledge pillar for **Planting** to track botanical knowledge, gardening techniques, and the life cycle of ingredients. This connects the raw material (botany) to the creative output (cooking).
