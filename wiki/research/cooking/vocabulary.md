...
> **Why this matters:** Building a precise vocabulary is foundational for any system, whether in culinary arts, product management, or music composition. It allows us to reference specific patterns and techniques with high fidelity.
> **How to use it:** Reference this consolidated vocabulary when analyzing recipes, studying regional techniques, or structuring creative culinary projects.
> **Informs:** Culinary deep dives, regional cuisine mapping, and cross-domain design synthesis.

# 🍳 Cooking Vocabulary

This page consolidates culinary terms across different languages.
...
| **Les Routiers** | Roadside restaurants (Relais Routiers) known for traditional, hearty, and affordable fixed-price menus. | "Finding a reliable 'Routier' is a highlight of any French road trip." | |
| **Éclair** | An oblong pastry made with choux dough filled with cream and topped with icing. | Classic French pastry, literally meaning "flash of lightning." | |
| **Filetage** | The technique of filleting fish or meat to remove bones and yield clean fillets. | "Mastering filetage is essential for fish preparation." | |
| **Calvados** | An apple (or pear) brandy from the Normandy region of France. | Often used to deglaze pans or in desserts like Tarte Tatin. | |
...
| Word | Meaning | Example | etc |
| :--- | :--- | :--- | :--- |
| **Bodega** | A wine cellar or winery in Spanish-speaking countries; also refers to a small convenience store in some regions (like NYC). | "We visited a beautiful bodega in La Rioja for a tasting." | |
| **Caña de Lomo** | A cured meat product made from the whole pork tenderloin (lomo), seasoned and stuffed into a casing. | "Caña de lomo is one of the most prized Spanish charcuterie items." | Lomo (loin/tenderloin) |
| **Cortador de Jamón** | A professional ham carver specializing in slicing Spanish dry-cured ham (jamón). | "The cortador de jamón at the event showed incredible precision." | Jamón (ham), Cortador (cutter/carver) |
| **Parrilla** | A Spanish open-fire grill or steakhouse. | "The steak was masterfully cooked on the parrilla." | |
...
| Word | Meaning | Example | etc |
| :--- | :--- | :--- | :--- |
| **しまずし** | Island sushi from Izu and Ogasawara; fish marinated in soy sauce and served with spicy mustard (karashi). (KR: **시마즈시**) | Typical of the Izu and Ogasawara Islands. | |
| **ホルモン** | Horumon; offal or innards (organ meats), typically grilled in Yakiniku or used in stews (Motsunabe). (KR: **호르몬**) | "Horumon-yaki" is a popular Japanese BBQ dish. | |
| **もつ鍋** | Motsunabe; a Japanese hot pot dish made from beef or pork offal (motsu), leeks, and cabbage in a soy or miso broth. (KR: **모츠나베**) | Originating from Fukuoka. | |
| **やきにく** | Yakiniku; "grilled meat" style of cooking bite-sized meat and vegetables over charcoal or gas. (KR: **야키니쿠**) | Often features various cuts of beef and [[#🇯🇵 Japanese\|Horumon]]. | |
| **懐石** | Kaiseki (Tea-ceremony style); a traditional multi-course meal originally served before a tea ceremony, focusing on simplicity and seasonal ingredients. (KR: **카이세키**) | Often called "Cha-kaiseki" to distinguish it from the banquet style. | |
| **会席** | Kaiseki (Banquet style); a formal, multi-course Japanese haute cuisine meal often served at parties or ryokans, focusing on sake and hospitality. (KR: **카이세키**) | The most common form of Japanese fine dining today. | |
| **どんぶり (丼)** | Donburi; a Japanese "rice bowl dish" consisting of fish, meat, vegetables or other ingredients simmered together and served over rice. (KR: **돈부리**) | Examples include Katsudon, Gyudon, and Oyakodon. | 돈 (丼): 덮밥 |
| **海鮮丼 (かいせんどん)** | Kaisendon; a Japanese rice bowl topped with fresh raw seafood. (KR: **카이센동**) | | 카이센 (海鮮): 해산물, 돈 (丼): 덮밥 |
| **旨だし (うまだし)** | Umadashi; "delicious stock" or "savory dashi"; a flavorful broth used as a base in Japanese cooking. (KR: **감칠맛 나는 국물 / 맛있는 육수**) | Often used to enhance the umami of soups and simmered dishes. | 旨 (うま): Delicious, だし (出汁): Stock |
| **旨味 (うまみ)** | Umami; the fifth basic taste, often described as savory or meaty, produced by glutamates and nucleotides. (KR: **우마미 / 감칠맛**) | Fundamental to dashi, fermented foods, and slow-cooked dishes. | 旨 (うま): Delicious, 味 (み): Taste |
| **かにすき** | Kanisuki; a Japanese crab hot pot (nabe) where fresh crab and vegetables are simmered in a light soy-based broth. (KR: **카니스키**) | Often enjoyed in winter, particularly in regions famous for crab. | かに (Kani): Crab |
| **炉端焼き** | Robatayaki; "Robata" meaning the edge of the hearth and "Yaki" meaning to grill; a Japanese culinary style of grilling fish, meat, and vegetables over a charcoal hearth, often served directly from the grill to customers. (KR: **로바다야끼**) | Known for its lively atmosphere and fresh, charcoal-grilled ingredients. | 炉端 (Robata): Edge of hearth, 焼き (Yaki): Grilled |
| **もりこぼし (盛りこぼし)** | Morikoboshi; a traditional Japanese style of serving sake (nihonshu) where a glass is placed inside a wooden box (masu) or on a small saucer, and sake is poured until it overflows into the container. (KR: **모리코보시**; 일본 이자카야나 선술집에서 사케(니혼슈) 잔 밑에 나무 받침(마스)이나 작은 접시를 받치고, 술잔이 넘치도록 가득 따라주는 전통적인 서비스 및 방식) | Often seen in traditional Izakayas as a gesture of generosity and hospitality. | もり (Mori): Heaping, こぼし (Koboshi): Spilling/Overflowing |
