...
- **Small Robot Company** (Agri-tech)
- **Qureight** (Bio-data analysis)
...
- **ComplyAdvantage** (Financial Crime Detection)
- **Eigen Technologies** (Document AI)
- **Recordsure** (Compliance AI)
...
- **BenevolentAI** (AI for Drug Discovery)
