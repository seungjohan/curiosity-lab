...
- [MJ Kang Blog](https://blog.mj-kang.com)
- [Unan Palms - Paper Review](https://unan.palms.blog/paper-review-2)
- [Alessandra Krick](https://www.alessandrakrick.com/homepage)
...
## Materials
- [AI created 200 Figma variables all by itself](https://www.youtube.com/watch?v=Aaebz-Q0OYY&t=997s)
- [Reference Video 2](https://www.youtube.com/watch?v=1ZQErQ4Hsjg)

## Key Questions
- **Combine or Separate Blog & Portfolio?**
  - Combined into a single SPA for a seamless experience.
- **Develop Resume page with GitHub?**
  - Integrated into the Portfolio and Home pages.

## Prompt History Summary
The project evolved through 32+ iterations of prompts, focusing on:
1. **Initial Prototyping**: Setting up the basic blog/portfolio structure.
2. **Feature Expansion**: Adding hashtag filtering, "About" page, and responsive layouts.
3. **Refinement**: Polishing the footer, header, and blog post layout (Substack-inspired).
4. **Project Case Studies**: Redesigning project cards to show Impact/What I Did/Outcome.
